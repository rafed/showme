...
class ScholarParserTest(unittest.TestCase):
    ...
    def testGetTitle(self):
        ...
        self.assertEqual(self.scholarParser._getTitle(self.soup), title)
    ...
    def testGetDescription(self):
        ...
        self.assertEqual(self.scholarParser._getDescription(self.soup), description)

    def testGetYear(self):
        year = "2008"
        self.assertEqual(self.scholarParser._getYear(self.soup), year)

    def testAuthors(self):
        authors = ["Wang", "Xu"]
        self.assertEqual(self.scholarParser._getAuthors(self.soup), authors)
    
    def testGetSiteLink(self):
        sitelink = "http://ieeexplore.ieee.org/abstract/document/4548235/"
        self.assertEqual(self.scholarParser._getSiteLink(self.soup), sitelink)
